...
from fedele_dns.models import Record, RecordTypeChoices, Zone, View, NameServer
from fedele_dns.tables import RelatedRecordTable
...
class RelatedDNSRecords(PluginTemplateExtension):
    ...
    def right_page(self):
        ...
        return self.render(
            "fedele_dns/record/related.html",
            extra_context={
...
class RelatedDNSObjects(PluginTemplateExtension):
    ...
    def left_page(self):
        ...
        return self.render(
            "fedele_dns/related_dns_objects.html",
            extra_context={
...
elif get_plugin_config("fedele_dns", "feature_ipam_dns_info"):
