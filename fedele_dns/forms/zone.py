...
from fedele_dns.utilities import name_to_unicode
...
class ZoneForm(TenancyForm, NetBoxModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        defaults = settings.PLUGINS_CONFIG.get("fedele_dns")
...
class ZoneImportForm(NetBoxModelImportForm):
    ...
    def _get_default_value(self, field):
        _default_values = settings.PLUGINS_CONFIG.get("fedele_dns", {})
...
class ZoneBulkEditForm(NetBoxModelBulkEditForm):
    view = DynamicModelChoiceField(
        ...
        label="View",
        widget=APISelect(
            attrs={"data-url": reverse_lazy("plugins-api:fedele_dns-api:view-list")}
        ),
    )
    status = forms.ChoiceField(
        choices=add_blank_choice(ZoneStatusChoices),
    ...
    soa_mname = DynamicModelChoiceField(
        ...
        widget=APISelect(
            attrs={
                "data-url": reverse_lazy("plugins-api:fedele_dns-api:nameserver-list")
            }
        ),
    )
    soa_rname = forms.CharField(
    ...
    registrar = DynamicModelChoiceField(
        ...
        widget=APISelect(
            attrs={
                "data-url": reverse_lazy("plugins-api:fedele_dns-api:registrar-list")
            }
        ),
    )
    registry_domain_id = forms.CharField(
    ...
    registrant = DynamicModelChoiceField(
        ...
        required=False,
        widget=APISelect(
            attrs={"data-url": reverse_lazy("plugins-api:fedele_dns-api:contact-list")}
        ),
    )
