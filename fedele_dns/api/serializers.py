...
from fedele_dns.api.nested_serializers import (
...
from fedele_dns.models import View, Zone, NameServer, Record, Registrar, Contact


class ViewSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:fedele_dns-api:view-detail"
    )
...
class ZoneSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:fedele_dns-api:zone-detail"
    )
...
class NameServerSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:fedele_dns-api:nameserver-detail"
    )
...
class RecordSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:fedele_dns-api:record-detail"
    )
...
class RegistrarSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:fedele_dns-api:registrar-detail"
    )
...
class ContactSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:fedele_dns-api:contact-detail"
    )
