...
from fedele_dns.tables import RecordTable, ManagedRecordTable
from fedele_dns.utilities import value_to_unicode
...
class ManagedRecordListView(generic.ObjectListView):
    ...
    actions = ("export",)
    template_name = "fedele_dns/record/managed.html"
...
class RecordEditView(generic.ObjectEditView):
    ...
    form = RecordForm
    default_return_url = "plugins:fedele_dns:record_list"
