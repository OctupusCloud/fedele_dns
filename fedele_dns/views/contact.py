...
from fedele_dns.models import Contact, Zone
from fedele_dns.filters import ContactFilter, ZoneFilter
...
from fedele_dns.tables import ContactTable, ZoneTable
...
class ContactEditView(generic.ObjectEditView):
    queryset = Contact.objects.all()
    form = ContactForm
    default_return_url = "plugins:fedele_dns:contact_list"
