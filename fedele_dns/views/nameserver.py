...
from fedele_dns.filters import NameServerFilter, ZoneFilter
...
from fedele_dns.models import Zone, NameServer
from fedele_dns.tables import NameServerTable, ZoneTable
...
class NameServerEditView(generic.ObjectEditView):
    queryset = NameServer.objects.all()
    form = NameServerForm
    default_return_url = "plugins:fedele_dns:nameserver_list"
