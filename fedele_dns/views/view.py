...
from fedele_dns.models import View, Zone
from fedele_dns.filters import ViewFilter, ZoneFilter
from fedele_dns.forms import ViewForm, ViewFilterForm, ViewImportForm, ViewBulkEditForm
from fedele_dns.tables import ViewTable, ZoneTable
...
class ViewEditView(generic.ObjectEditView):
    queryset = View.objects.all()
    form = ViewForm
    default_return_url = "plugins:fedele_dns:view_list"
