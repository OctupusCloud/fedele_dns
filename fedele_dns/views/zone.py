...
from fedele_dns.filters import ZoneFilter, RecordFilter
...
from fedele_dns.models import Record, Zone
from fedele_dns.tables import (
    ZoneTable,
    RecordTable,
    ManagedRecordTable,
)
...
class ZoneEditView(generic.ObjectEditView):
    ...
    form = ZoneForm
    default_return_url = "plugins:fedele_dns:zone_list"
...
class ZoneRegistrationView(generic.ObjectView):
    queryset = Zone.objects.all()
    template_name = "fedele_dns/zone/registration.html"
...
class ZoneRecordListView(generic.ObjectChildrenView):
    ...
    template_name = "fedele_dns/zone/record.html"
    hide_if_empty = True

    tab = ViewTab(
        label="Records",
        permission="fedele_dns.view_record",
...
class ZoneManagedRecordListView(generic.ObjectChildrenView):
    ...
    filterset = RecordFilter
    template_name = "fedele_dns/zone/managed_record.html"
    actions = ("changelog",)
