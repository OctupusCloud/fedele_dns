...
from fedele_dns.fields import NetworkField
from fedele_dns.utilities import (
    arpa_to_prefix,
    name_to_unicode,
    normalize_name,
    NameFormatError,
)
from fedele_dns.validators import (
    validate_fqdn,
...
# -
import fedele_dns.models.record as record
...
class Zone(NetBoxModel):
    ...
    def __str__(self):
        if self.name == "." and get_plugin_config("fedele_dns", "enable_root_zones"):
            name = ". (root zone)"
        else:
            try:
    ...
    def get_absolute_url(self):
        return reverse("plugins:fedele_dns:zone", kwargs={"pk": self.pk})
    ...
    def save(self, *args, **kwargs):
        ...
        if (
            ...
            if (
                get_plugin_config("fedele_dns", "feature_ipam_coupling")
                and name_changed
            ):
    ...
    def delete(self, *args, **kwargs):
        with transaction.atomic():
            ...
            if get_plugin_config("fedele_dns", "feature_ipam_coupling"):
