...
from fedele_dns.models import Record, Zone, NameServer, RecordTypeChoices
...
class IPAMCouplingAPITest(APITestCase):
    ...
    @override_settings(PLUGINS_CONFIG={"fedele_dns": {"feature_ipam_coupling": True}})
    def test_create_ip_with_dns_permission(self):
        ...
        self.add_permissions("fedele_dns.add_record")
    ...
    def test_delete_ip_with_dns_permission(self):
        ...
        self.add_permissions("fedele_dns.delete_record")
    ...
    def test_modify_name_with_dns_permission(self):
        ...
        self.add_permissions("fedele_dns.change_record")
